...
// exchangeGitHubToken exchanges a GitHub device-flow OAuth token for a GitHub Copilot API token.
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, req *http.Header, info *relaycommon.RelayInfo) error {
	...
	// or a GitHub OAuth token generated by device-code authorization.
	copilotToken := key
...
// isGitHubToken checks if the key looks like a GitHub OAuth token.
