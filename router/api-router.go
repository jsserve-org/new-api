...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/copilot/device/start", controller.StartCopilotDeviceAuth)
			channelRoute.POST("/copilot/device/complete", controller.CompleteCopilotDeviceAuth)
			channelRoute.POST("/:id/copilot/device/start", controller.StartCopilotDeviceAuthForChannel)
			channelRoute.POST("/:id/copilot/device/complete", controller.CompleteCopilotDeviceAuthForChannel)
